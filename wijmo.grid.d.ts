...
export declare class FlexGrid extends wjcCore.Control {
    ...
    _updateFocus(force: boolean): void;
...
export declare class GridPanel {
    ...
    _renderHiddenHeaderRow(rng: CellRange, state: boolean): number;
    _renderHiddenHeaderCell(row: HTMLElement, c: number, rng: CellRange, state: boolean, ctr: number): number;
...
export declare class _EditHandler {
    ...
    readonly activeEditor: HTMLInputElement;
    readonly editRange: CellRange;
    _updateEditorCell(r: number, c: number, updateHdr: boolean): void;
    _updateCell(cell: HTMLElement): void;
